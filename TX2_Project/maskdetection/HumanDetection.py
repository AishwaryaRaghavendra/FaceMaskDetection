...
def detect(image, thresh=.5, hier_thresh=.5, nms=.45, debug=False):  
    """ 
    ...
    custom_image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)                   #Take the image and get RGB Channels
    custom_image = cv2.resize(custom_image, (lib.network_width(             #Resize
